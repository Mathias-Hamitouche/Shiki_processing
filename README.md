Shiki Processing is made for an intermediate post-processing step for LC-MS /GC-MS data processing using MZmine.
...
- Determine the plausibility of chemical formulas using atom ratios and RDBE and delete features with impossible chemical formulas
              -> impossible if : H/C = 0, RDBE < 0, RDBE > C
              -> unlikely if : O/C = 0 and N/C > 0.5, RDBE/C > 0.8
